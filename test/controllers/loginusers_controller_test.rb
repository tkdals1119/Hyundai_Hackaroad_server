...
class LoginusersControllerTest < ActionController::TestCase
  ...
  test "should create loginuser" do
    assert_difference('Loginuser.count') do
      post :create, loginuser: { userid: @loginuser.userid, username: @loginuser.username, userpw: @loginuser.userpw }
    end
  ...
  test "should update loginuser" do
    patch :update, id: @loginuser, loginuser: { userid: @loginuser.userid, username: @loginuser.username, userpw: @loginuser.userpw }
    assert_redirected_to loginuser_path(assigns(:loginuser))
  end
